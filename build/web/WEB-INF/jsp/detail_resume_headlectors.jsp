    ...
    <div class="page-container">	
		...
		<script>
                ...
                <div class="row" style="padding-left: 50px; padding-top: 30px">
                    <div class="col-md-12">
                        Berikut adalah data Dosen Tetap yang sudah memiliki <span style="font-weight: bold">Jabatan Fungsional Lektor Kepala</span>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function reloadData(){
                ...
                $.ajax({
                    url : 'getDetailReportResumeHeadlectors.htm',
                    type: 'GET',
                    data:{
                        idFaculty: idFaculty,
                        idMajor: idMajor
