                        ...
                        success: function(response){
                            ...
                            for (var i =0; i < len; i++){
                                if (data[i].state === 1){
                                    ...
                                    content +='<li>\n\
                                            ' + data[i].numberRequirement + '<br>\n\
                                            <a href="saveProgressSertification.htm?idDetail=' + data[i].idDetail + '&idProgressHistory=' + data[i].idProgressHistory + '">\n\
                            ...
                            $('#selesai').click(function(){
                                $.ajax({
                                    url: 'updateProgressHistorySertification.htm',
                                    data : 'idProgressHistory=' + idProgressHistory,
                                    type: 'GET',
                                    success: function (response) {
                                        var data = JSON.parse(response);
                                        var dataConfirm = confirm('Apakah anda ingin menginputkan SK Historis Sertifikasi Dosen ?');
                                        if (dataConfirm === true){
