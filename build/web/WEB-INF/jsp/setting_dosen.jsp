                               ...
                               aria-expanded="false">
                                <div class="profile_img">	
                                    ...
                                    <div class="user-name">
                                        ...
                                        <input type="hidden" name="idLecturer" value="${sessionScope.idLecturer}"/>
                                    </div>
			 ...
			 $(window).scroll(function(){
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <label style="padding-left: 188px; padding-top: 30px">Pengaturan Dosen Tetap</label>
                            </div>
                        </div>
                        <hr>
                        <br>
                        ...
                        success : function(response){
                            ...
                            if (data.status === 0){
                                ...
                                if (newPassword !== password) {
                                    ...
                                    $.ajax({
                                        url: 'updateLecturer.htm',
                                        data: {idLecturer: idLecturer , username: username, password: password},
                                        type: 'GET',
                                        success : function(response){
