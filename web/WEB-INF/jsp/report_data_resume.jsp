        ...
        $(document).ready(function() {
            ...
            var tableBody = $('#tableBody').DataTable({
                ...
                columns: [
                    ...
                    { data: 'nameLecturer'},
                    { data: 'idGender', searchable:false},
                    { data: null, sortable: false,
            ...
            $('#tableBody tbody').on('click', 'button#loadDetail', function () {
                ...
                window.location.assign("detail_resume.htm?idLecturer=" + data.idLecturer + "&nameLecturer=" + data.nameLecturer + "&idFaculty=" + idFaculty + "&idMajor=" + idMajor);
            });
        });
...
//                                            <td>' + data[i].idGender + '</td>\n\
//                                            <td>\n\
//                                                <a href="detail_resume.htm?idLecturer=' + data[i].idLecturer + '">\n\
