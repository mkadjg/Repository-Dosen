    ...
    <div class="page-container" style="overflow: scroll">	
		...
		$(document).ready(function() {
			 ...
			 $(window).scroll(function(){
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="saveFileProfessor.htm"
                              id="formFileProfessor"
                              name="fileDto"
                              method="POST">
                            <div class="row">
                                <div class="col-md-4" style="padding-left: 50px; padding-top: 3px">
                                    <select name="idDetail"
                                        ...
                                        <c:forEach var="dataDetailFile" items="${fileProfessor}">
    ...
    <script>
        var toggle = true;
            ...
            $(document).ready(function(){
                ...
                $('#formFileProfessor').submit(function(e){
                    e.preventDefault();
                    var formData = new FormData();
                    formData.append('file', $('input[name=file]')[0].files[0]);
                    $.ajax({
                        url: "uploadFileProfessor.htm",
                        data: formData,
                        type: 'POST',
                        contentType: false,
                        processData: false,
