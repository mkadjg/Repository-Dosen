    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    { data: 'state', sortable: false,
                      render : function(data, type, full) {
                          if (data === 2){
                            ...
                            return '<button id="infoLectureHistory"><span class="fa fa-info-circle"></span></button>';
                          }
                        }
                    }
                ]
            ...
            $('#tableLecturer tbody').on('click', 'button#infoLectureHistory', function () {
                var data = tableLecturer.row(this.closest('tr')).data();
                var dataConfirm = confirm('Dosen yang bersangkutan belum memiliki riwayat mengajar 2 tahun \nApakah anda ingin melengkapi persayaratan ?');
                if (dataConfirm === true){
            ...
            $('#tableLecturer tbody').on('click', 'button#infoDetailFile', function () {
                ...
                if (dataConfirm === true){
                    window.location.assign("addFileNidn.htm?idLecturer=" + data.idLecturer);
                }
            });
