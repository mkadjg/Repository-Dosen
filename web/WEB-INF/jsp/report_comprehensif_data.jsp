    ...
    <div class="page-container">	
		...
		<div class="header-main">
                    <div class="header-left col-md-6">
                        <center>
                            <h3 style="margin-top: 13px;">LAPORAN KELENGKAPAN PORTOFOLIO</h3>
                        </center>							
                ...
                columns: [
                    ...
                    { data: null, sortable: false,
                      render : function(data, type, full) {
                            return '<button id="detailHistory"><span class="fa fa-book"></span></button>\n\
                                    <button id="detailProgress"><span class="fa fa-bar-chart"></span></button>';
                        }
                    }
                ]
            });
            
            $('#tableLecturer tbody').on('click', 'button#detailHistory', function () {
                var data = tableLecturer.row(this.closest('tr')).data();
                window.location.assign('showDetailHistoryComprehensif.htm?idLecturer=' + data.idLecturer);
            });
            
            $('#tableLecturer tbody').on('click', 'button#detailProgress', function () {
                var data = tableLecturer.row(this.closest('tr')).data();
                window.location.assign('showDetailProgressComprehensif.htm?idLecturer=' + data.idLecturer);
            });
